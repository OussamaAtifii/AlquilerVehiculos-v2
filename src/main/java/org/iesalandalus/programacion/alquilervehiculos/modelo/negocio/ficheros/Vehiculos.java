...
public class Vehiculos implements IVehiculos {
	...
	private void leerXml() throws ParserConfigurationException, SAXException, IOException, OperationNotSupportedException {
		// Pasar xml a dom:
		...
		// Iteración sobre la lista de nodos, pasar los elementos a vehiculo e insertarlos en la colección de vehiculos:
	...
	private Element vehiculoToElement(Document dom, Vehiculo vehiculo) {
		...
		// Devolver elemento vehiculo con todos los elementos y atributos hijos enlazados:
		return eVehiculo;
	}
