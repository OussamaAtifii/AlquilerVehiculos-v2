...
public class Alquileres implements IAlquileres {
	...
	private void leerXml() throws OperationNotSupportedException, ParserConfigurationException, SAXException, IOException {
		// Pasar xml a dom:
		...
		// Iteración sobre la lista de nodos, pasar los elementos a alquiler e insertarlos en la colección de vehiculos:
	...
	private void escribirXml() throws ParserConfigurationException, TransformerException {
		...
		// Iterar sobre la coleccion de clientes e ir transformando cada alquiler a elemento:
	...
	private Element alquilerToElement(Document dom, Alquiler alquiler) {
		...
		// Crear elemento fecha alquiler, darle valor y enlazar con el elemento alquiler:
		...
		// Comprobar si fecha devolución es nulo, pasarlo a "" para no tener NullPointerException,
		// en caso contrario, formateamos fecha y pasar a string:
		String fecha = (alquiler.getFechaDevolucion() == null) ? "" : alquiler.getFechaDevolucion().format(FORMATO_FECHA).
		toString();
		...
		// Devolver elemento alquiler con todos los elementos y atributos hijos enlazados:
		return eAlquiler;
	}
